...
prompt Created on 2012年6月10日 by Bruce.Huang
set feedback off
set define off
...
comment on table ASSETCATEGORY
  is '资产分类表';
...
comment on column ASSETMAINTAIN.MAINTAINCONTENT
  is '已维修明细';
comment on column ASSETMAINTAIN.STORAGETITLE
  is '区分字段：分公司或项目体';
comment on column ASSETMAINTAIN.STORAGEID
  is '项目体ID或分公司ID';
comment on column ASSETMAINTAIN.SUBCOMPANY
  is '分公司';
comment on column ASSETMAINTAIN.SUBCOMPANYCONTACTORID
  is '分公司联系人';
comment on column ASSETMAINTAIN.CONTACTPHONE
  is '联系电话';
...
comment on table ASSETMAINTAINDETAIL
  is '维修明细信息';
...
comment on column ASSETMAINTAINDETAIL.ASSETNO
  is '设备编号';
comment on column ASSETMAINTAINDETAIL.PLANDATE
  is '计划维修日期';
comment on column ASSETMAINTAINDETAIL.ACTUALDATE
  is '实际维修日期';
...
comment on column ASSETMOVE.MOVEDCONTENT
  is '已移机明细';
comment on column ASSETMOVE.STORAGETITLE
  is '区分字段：分公司或项目体';
comment on column ASSETMOVE.STORAGEID
  is '项目体ID或分公司ID';
comment on column ASSETMOVE.SUBCOMPANY
  is '分公司';
comment on column ASSETMOVE.SUBCOMPANYCONTACTORID
  is '分公司联系人';
comment on column ASSETMOVE.CONTACTPHONE
  is '联系人电话';
...
comment on table ASSETMOVEDETAIL
  is '移机明细';
...
comment on column ASSETREMOVE.REMOVEDCONTENT
  is '已维修明细';
comment on column ASSETREMOVE.STORAGETITLE
  is '区分字段：分公司或项目体';
comment on column ASSETREMOVE.STORAGEID
  is '项目体ID或分公司ID';
comment on column ASSETREMOVE.SUBCOMPANY
  is '分公司';
comment on column ASSETREMOVE.SUBCOMPANYCONTACTORID
  is '分公司联系人';
comment on column ASSETREMOVE.CONTACTPHONE
  is '联系电话';
...
comment on table ASSETREMOVEDETAIL
  is '拆机明细';
...
comment on table ASSETSETUPINFO
  is '安装信息';
...
comment on table ASSETSETUPDETAIL
  is '安装明细';
...
prompt Creating ASSET_CONFIG...
create table ASSET_CONFIG
(
  CONFIGID     VARCHAR2(40) not null,
  CATEGORYID   VARCHAR2(40),
  CATEGORYNAME VARCHAR2(40),
  CONFIGNAME   VARCHAR2(40),
  CONFIGVALUE  VARCHAR2(40),
  CREATEDDATE  DATE,
...
comment on table ASSET_CONFIG
  is '数据字典';
comment on column ASSET_CONFIG.CONFIGID
  is '主键Id';
comment on column ASSET_CONFIG.CATEGORYID
  is '配置项分类编号';
comment on column ASSET_CONFIG.CATEGORYNAME
  is '配置项分类名称';
comment on column ASSET_CONFIG.CONFIGNAME
  is '配置项名';
comment on column ASSET_CONFIG.CONFIGVALUE
  is '配置项值';
comment on column ASSET_CONFIG.CREATEDDATE
  is '创建时间';
comment on column ASSET_CONFIG.CREATOR
  is '创建人';
alter table ASSET_CONFIG
...
prompt Creating ASSET_SCRAPPED...
create table ASSET_SCRAPPED
(
  ASSET_SCRAPPED_ID VARCHAR2(40) not null,
  SCRAPPEDDATE      DATE,
  SCRAPPEDUSER      NVARCHAR2(40),
  ASSETNO           VARCHAR2(20) not null,
  APPROVEUSER       NVARCHAR2(50),
  APPROVEDATE       DATE,
  REJECTREASON      NVARCHAR2(500),
...
comment on table ASSET_SCRAPPED
  is '报废信息';
comment on column ASSET_SCRAPPED.ASSET_SCRAPPED_ID
  is '编号';
comment on column ASSET_SCRAPPED.SCRAPPEDDATE
  is '报废日期';
comment on column ASSET_SCRAPPED.SCRAPPEDUSER
  is '报废人';
comment on column ASSET_SCRAPPED.ASSETNO
  is '设备编号';
comment on column ASSET_SCRAPPED.APPROVEUSER
  is '审核人';
comment on column ASSET_SCRAPPED.APPROVEDATE
  is '审核日期';
comment on column ASSET_SCRAPPED.REJECTREASON
  is '拒绝理由';
comment on column ASSET_SCRAPPED.CREATEDDATE
  is '创建日期';
comment on column ASSET_SCRAPPED.CREATOR
  is '创建人';
comment on column ASSET_SCRAPPED.APPROVEDSTATE
  is '审核状态';
alter table ASSET_SCRAPPED
  add constraint PK_ASSET_SCRAPPED_ID primary key (ASSET_SCRAPPED_ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
comment on column PROCUREMENTCONTRACTDETAIL.INPUTNUMBER
  is '已验收登记数量';
comment on column PROCUREMENTCONTRACTDETAIL.PSDETAILID
  is '计划采购单明细编号';
comment on column PROCUREMENTCONTRACTDETAIL.PSID
  is '计划采购单号';
...
comment on column ROLEINFO.ROLESTATE
  is '角色状态';
comment on column ROLEINFO.DESCRIPTION
  is '角色描述';
comment on column ROLEINFO.ALLOWEDIT
  is '允许编辑';
comment on column ROLEINFO.CREATEDDATE
  is '创建时间';
comment on column ROLEINFO.CREATOR
  is '创建者';
comment on column ROLEINFO.LASTMODIFIEDDATE
  is '最近修改时间';
comment on column ROLEINFO.LASTMODIFIEDBY
  is '最近修改者';
...
prompt Disabling triggers for ASSET_CONFIG...
alter table ASSET_CONFIG disable all triggers;
prompt Disabling triggers for ASSET_SCRAPPED...
alter table ASSET_SCRAPPED disable all triggers;
...
values ('ZR900010114179', '0101', '121', '6611', 3, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114180', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114181', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114182', '0101', '121', '6611', 3, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114183', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114184', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114185', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114186', '0101', '121', '6611', 1, 10, 1121, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '121', 'Subcompany', '20153', '采购合同2012060008', '9e6a41b5a27a418ea77d631716c237e9');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114191', '0101', '11', '6611', 2, 2, 11, null, 0, 1, '02', to_date('01-06-2003', 'dd-mm-yyyy'), to_date('01-06-2005', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114192', '0101', '11', '6611', 2, 10, 11, null, 0, 1, '02', to_date('01-06-2002', 'dd-mm-yyyy'), to_date('01-06-2012', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114193', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114194', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114195', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114196', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114197', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114198', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114199', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114200', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114201', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114202', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114203', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114204', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114205', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114206', '0101', '11', '7542', 3, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114207', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114208', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114209', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114210', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114211', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114212', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114213', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114214', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114215', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114216', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114217', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114218', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114219', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114220', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114221', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114222', '0101', '11', '14463', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114223', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114224', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114225', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010063', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010064', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010065', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010066', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010067', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010068', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010069', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010070', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010071', '0201', 'HTC Mozart', '14463', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010072', '0201', 'HTC Mozart', '10122', 1, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Project', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010073', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010074', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010075', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010076', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010077', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010078', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010079', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010080', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010081', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010082', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010083', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010084', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010085', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010086', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010087', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010088', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010089', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010090', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010091', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010092', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010093', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010094', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010095', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010096', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010097', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010098', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010099', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010100', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114226', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114227', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114228', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114229', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114230', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114231', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114232', '0101', '11', '14562', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114233', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114234', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114235', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114236', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114237', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114238', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114239', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114240', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114241', '0101', '11', '1432230', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114242', '0101', '11', '1432230', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114243', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114244', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
commit;
prompt 100 records committed...
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114245', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114246', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114247', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114248', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114249', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114250', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114251', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114252', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114253', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114254', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114255', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114256', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114257', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114258', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114259', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114260', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114261', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114262', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114263', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114264', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114265', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114266', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114267', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114268', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114269', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114270', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114271', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114272', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114273', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114274', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114275', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114276', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114277', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114278', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114279', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114280', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114281', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114282', '0101', '11', '7542', 2, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Subcompany', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114283', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114284', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114285', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114286', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR900010114287', '0101', '11', '10122', 1, 10, 11, null, 0, 0, '02', to_date('05-06-2012', 'dd-mm-yyyy'), to_date('05-06-2022', 'dd-mm-yyyy'), '11', 'Project', '20153', '采购合同2012060008', '96a0e38bb2ec4548978c262461f0ff54');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010001', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010002', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010003', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010004', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010005', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010006', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010007', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010008', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010009', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010010', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010011', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010012', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010013', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010014', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010015', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010016', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010017', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010018', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010019', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010020', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010021', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010022', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010023', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010024', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010025', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010026', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010027', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010028', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010029', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010030', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010031', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010032', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010033', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010034', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010035', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010036', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010037', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010038', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010039', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010040', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010041', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010042', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010043', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010044', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010045', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010046', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010047', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010048', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010049', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010050', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010051', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010052', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010053', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010054', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010055', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010056', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010057', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
commit;
prompt 200 records committed...
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010058', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010059', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010060', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010061', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR70502010062', '0201', 'HTC Mozart', '02', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '15103', '采购合同2012060009', 'c262e7b76d2947b69ce263511161fdad');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020001', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020002', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020003', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020004', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020005', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020006', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020007', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020008', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020009', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020010', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020011', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020012', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020013', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020014', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020015', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020016', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020017', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020018', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020019', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020020', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020021', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020022', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020023', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020024', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020025', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020026', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020027', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020028', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020029', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020030', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020031', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020032', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020033', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020034', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020035', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020036', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020037', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020038', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020039', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020040', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020041', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020042', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020043', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020044', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020045', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020046', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020047', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020048', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020049', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020050', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020051', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020052', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020053', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020054', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020055', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020056', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020057', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020058', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020059', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020060', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020061', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020062', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020063', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020064', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020065', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020066', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020067', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020068', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020069', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020070', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020071', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020072', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020073', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020074', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020075', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020076', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020077', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020078', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020079', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020080', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020081', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020082', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020083', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020084', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020085', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020086', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020087', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020088', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020089', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020090', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020091', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020092', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020093', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020094', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020095', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
commit;
prompt 300 records committed...
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020096', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020097', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020098', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020099', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
insert into ASSET (ASSETNO, ASSETCATEGORYID, ASSETNAME, STORAGE, STATE, DEPRECIATIONYEAR, UNITPRICE, BRAND, MANAGEMODE, FINANCECATEGORY, SUPPLIERID, PURCHASEDATE, EXPIREDDATE, ASSETSPECIFICATION, STORAGEFLAG, SUBCOMPANY, CONTRACTID, CONTRACTDETAILID)
values ('ZR90003020100', '0302', 'HTC Mozart', '03', 2, 10, 20000, null, 0, 0, '02', to_date('09-06-2012', 'dd-mm-yyyy'), to_date('09-06-2022', 'dd-mm-yyyy'), 'HTC Mozart 90', 'Supplier', '20153', '采购合同2012060013', 'c3a9037e405741749a2755908b665f0b');
commit;
...
insert into ASSETSUPPLIER (SUPPLIERID, SUPPLIERNAME, REMARK, SYSTEM, ASSETCATEGORYID)
values ('03', '光显', null, '光显', '03');
commit;
prompt 3 records loaded
prompt Loading ASSET_CONFIG...
insert into ASSET_CONFIG (CONFIGID, CATEGORYID, CATEGORYNAME, CONFIGNAME, CONFIGVALUE, CREATEDDATE, CREATOR)
values ('MaintaintypeProject', 'Maintaintype', '保修来源', '项目体', 'Project', null, null);
insert into ASSET_CONFIG (CONFIGID, CATEGORYID, CATEGORYNAME, CONFIGNAME, CONFIGVALUE, CREATEDDATE, CREATOR)
values ('MaintaintypeSelfCheck', 'Maintaintype', '保修来源', '自检', 'SelfCheck', null, null);
insert into ASSET_CONFIG (CONFIGID, CATEGORYID, CATEGORYNAME, CONFIGNAME, CONFIGVALUE, CREATEDDATE, CREATOR)
values ('MaintaintypeMonthCheck', 'Maintaintype', '保修来源', '月检', 'MonthCheck', null, null);
commit;
prompt 3 records loaded
prompt Loading ASSET_SCRAPPED...
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060001', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114180', '王玲玲', to_date('10-06-2012 00:31:15', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('10-06-2012 00:01:28', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 3);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060002', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114179', '王玲玲', to_date('10-06-2012 00:30:49', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('10-06-2012 00:01:28', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 2);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060011', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114193', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060012', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114194', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060013', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114195', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060014', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114196', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060015', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114197', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060016', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114198', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060017', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114199', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060018', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114200', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060019', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114201', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060020', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114202', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060021', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114203', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060022', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114204', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060023', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114205', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060024', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114206', '王玲玲', to_date('10-06-2012 09:39:20', 'dd-mm-yyyy hh24:mi:ss'), '123456', to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 2);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060025', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114207', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060026', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114208', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060027', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114209', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060028', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114210', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060029', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114211', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060030', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114212', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060031', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114213', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060032', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114214', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060033', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114215', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060034', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114216', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060035', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114217', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060036', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114218', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060037', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114219', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060038', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114220', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060039', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114221', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060040', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114222', null, null, null, to_date('10-06-2012 09:38:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060041', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114179', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060042', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114182', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060043', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114183', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060044', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114184', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060045', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114185', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060046', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114186', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060047', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114192', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060048', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114191', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060049', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114180', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060050', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114181', null, null, null, to_date('10-06-2012 09:47:55', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060005', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114183', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060003', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114181', '王玲玲', to_date('10-06-2012 00:38:29', 'dd-mm-yyyy hh24:mi:ss'), '拒绝理由 ', to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 3);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060004', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114182', '王玲玲', to_date('10-06-2012 00:38:15', 'dd-mm-yyyy hh24:mi:ss'), 'wllwllwllwll', to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 2);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060006', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114184', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060007', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114185', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060008', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114186', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060009', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114191', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
insert into ASSET_SCRAPPED (ASSET_SCRAPPED_ID, SCRAPPEDDATE, SCRAPPEDUSER, ASSETNO, APPROVEUSER, APPROVEDATE, REJECTREASON, CREATEDDATE, CREATOR, APPROVEDSTATE)
values ('报废2012060010', to_date('10-06-2012', 'dd-mm-yyyy'), '王玲玲', 'ZR900010114192', null, null, null, to_date('10-06-2012 00:27:48', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', 1);
commit;
prompt 50 records loaded
prompt Loading BACCOUNT...
insert into BACCOUNT (ASSETNO, ASSETNAME, ACCOUNTEDDATE, ACCOUNTEDUSER, CREATEDDATE, CREATEDUSER)
values ('ZR900010114192', '11', to_date('10-06-2012 09:06:33', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', to_date('10-06-2012 09:06:33', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into BACCOUNT (ASSETNO, ASSETNAME, ACCOUNTEDDATE, ACCOUNTEDUSER, CREATEDDATE, CREATEDUSER)
values ('ZR900010114191', '11', to_date('10-06-2012 09:32:49', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', to_date('10-06-2012 09:32:49', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
commit;
...
values ('ZR7050104', null, 1, 0, 1, 4, 0, 20, 'ZR70501040020');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR7000201', null, 1, 0, 1, 4, 0, 5, 'ZR70002010005');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR9000201', null, 1, 0, 1, 4, 0, 1, 'ZR90002010001');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR9000301', null, 1, 0, 1, 4, 0, 1, 'ZR90003010001');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR9000104', null, 1, 0, 1, 4, 0, 5, 'ZR90001040005');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('报废201206', null, 1, 0, 1, 4, 0, 50, '报废2012060050');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR7050201', null, 1, 0, 1, 4, 0, 100, 'ZR70502010100');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
...
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR7050101', null, 1, 0, 1, 4, 0, 1108, 'ZR70501011108');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR9000101', null, 1, 0, 1, 4, 0, 14287, 'ZR900010114287');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR7000103', null, 1, 0, 1, 4, 0, 100, 'ZR70001030100');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR7000101', null, 1, 0, 1, 4, 0, 125, 'ZR70001010125');
insert into CODERULE (CODEPREFIX, RULENAME, ISNEEDCODEPREFIX, ISDEFAULT, STARTNUMBER, NUMBERWIDTH, YEARWIDTH, CURRENTNO, CURRENTSERIALNUMBER)
values ('ZR9000302', null, 1, 0, 1, 4, 0, 100, 'ZR90003020100');
commit;
...
insert into ROLEINFO (ROLEID, ROLENAME, ROLESTATE, DESCRIPTION, ALLOWEDIT, CREATEDDATE, CREATOR, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('adminRole', '超级管理员', 0, '超级系统管理员', 0, to_date('24-05-2012', 'dd-mm-yyyy'), '管理员', null, null);
insert into ROLEINFO (ROLEID, ROLENAME, ROLESTATE, DESCRIPTION, ALLOWEDIT, CREATEDDATE, CREATOR, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('6388877887c840de97c03e94f9984834', '111', 0, '1111', 1, to_date('06-06-2012 20:41:22', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', to_date('06-06-2012 20:41:22', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
commit;
prompt 2 records loaded
prompt Loading ROLEPERMISSION...
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '001002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '002001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '002002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '002003', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '002004', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '003', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '003001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '003002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '003003', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '003004', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '004', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '004001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '004002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '005', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '005001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '005002', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
insert into ROLEPERMISSION (ROLEID, MENUID, REMARK, LASTMODIFIEDDATE, LASTMODIFIEDBY, RIGHTCODE)
values ('adminRole', '001001', null, to_date('06-06-2012 20:30:17', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲', null);
commit;
prompt 19 records loaded
...
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129ed9f2c4f001c', 'adminRole', to_date('03-06-2012 19:31:43', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129edae90bd0038', 'de01380d959c4c9598dfb0a3cd8ac922', to_date('03-06-2012 19:16:08', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda9d5fc002a', 'a063dce7df2a4e11b48c18ba76a5a727', to_date('03-06-2012 19:42:25', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('402882f229ed348e0129ed367eb40001', '1f62393a047041bf927d27c15a9da42d', to_date('03-06-2012 19:42:32', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda99edf0029', 'adminRole', to_date('03-06-2012 19:42:43', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda2b2a70020', 'adminRole', to_date('09-06-2012 16:12:31', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda241dc001f', '1f62393a047041bf927d27c15a9da42d', to_date('03-06-2012 17:45:01', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda18080001e', 'a063dce7df2a4e11b48c18ba76a5a727', to_date('03-06-2012 17:45:19', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129ed927e850005', 'a063dce7df2a4e11b48c18ba76a5a727', to_date('03-06-2012 17:45:25', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129ed939c2a0006', 'adminRole', to_date('03-06-2012 18:42:29', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('402882f229ed2f330129ed2f5ad20001', 'a063dce7df2a4e11b48c18ba76a5a727', to_date('03-06-2012 18:43:00', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda0fc9a001d', 'de01380d959c4c9598dfb0a3cd8ac922', to_date('03-06-2012 17:49:07', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a898ad535e0bb250135e582eb8a0015', 'adminRole', to_date('05-06-2012 12:35:16', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a898ad5373ae75301375356640700a0', 'a063dce7df2a4e11b48c18ba76a5a727', to_date('03-06-2012 18:26:43', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
insert into USERMAPROLEINFO (USERID, ROLEID, LASTMODIFIEDDATE, LASTMODIFIEDBY)
values ('8a8ae48b29ed43280129eda74f800025', '1f62393a047041bf927d27c15a9da42d', to_date('03-06-2012 18:26:54', 'dd-mm-yyyy hh24:mi:ss'), '王玲玲');
commit;
...
prompt Enabling triggers for ASSET_CONFIG...
alter table ASSET_CONFIG enable all triggers;
prompt Enabling triggers for ASSET_SCRAPPED...
alter table ASSET_SCRAPPED enable all triggers;
