...
Calendar.prototype.draw = function() {
	...
	this.form.selectTodayButton.onclick = function () {
		...
		calendar.dateControl.value = today.formatStr(calendar.date2StringPattern);
		calendar.hide();
	}
};
			...
			tds[i].onclick = function () {
				if (calendar.dateControl){
					calendar.dateControl.value = new Date(calendar.date.getFullYear(),
														...
														this.innerHTML).formatStr(calendar.date2StringPattern);
				}
				calendar.hide();
			}
 ...
 */
Date.prototype.formatStr = function(style) {
	var o = {
