<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeBehind="Remove_Reply.aspx.cs" Inherits="FixedAsset.Web.Admin.Remove_Reply" %>
    ...
    <div class="content-box">
        <div class="content-box-header">
            <h3 style="cursor: s-resize;">
                <asp:Literal runat="server" ID="litTitle" Text="回复拆机申请" />
            </h3>
        </div>
                ...
                <fieldset>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <uc1:ucSelectUser ID="ucProjectcontactorid" IsShowUserName="true" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td style="width: 180px;">
                                计划拆机日期: <span style="color: Red">*</span>
                            </td>
                            <td>
