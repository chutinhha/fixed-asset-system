...
{
    public partial class Report_ShowCurrentAssets : System.Web.UI.Page
    {
        #region Events
        ...
        protected void LoadData(int pageIndex)
        {
            ...
            //}
            int recordCount = 0;
            var list = AssetService.RetrieveAssetRegisterReportDetailInfoPaging(search, pageIndex, pcData.PageSize, out recordCount);
