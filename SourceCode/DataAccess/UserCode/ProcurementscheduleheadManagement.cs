...
namespace FixedAsset.DataAccess
{
    public partial class ProcurementscheduleheadManagement:BaseManagement
    {
        ...
        public List<Procurementschedulehead> RetrieveProcurementscheduleheadsPaging(ProcurementscheduleheadSearch info,int pageIndex, int pageSize,out int count)
        {
            try
            {
                StringBuilder sqlCommand = new StringBuilder(@" SELECT ""PROCUREMENTSCHEDULEHEAD"".""PSID"",""PROCUREMENTSCHEDULEHEAD"".""PROCUREMENTSCHEDULEDATE"",""PROCUREMENTSCHEDULEHEAD"".""REASON"",""PROCUREMENTSCHEDULEHEAD"".""SUBCOMPANY"",""PROCUREMENTSCHEDULEHEAD"".""APPLYUSER"",
