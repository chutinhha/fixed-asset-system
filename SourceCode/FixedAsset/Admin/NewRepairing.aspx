<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeBehind="NewRepairing.aspx.cs" Inherits="FixedAsset.Web.Admin.NewRepairing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <script src="../Scripts/calendar.js" type="text/javascript"></script>
    <script type="text/javascript">
        function reset() {
            window.location.href = "NewRepairing.aspx";
        }
    </script>
</asp:Content>
                        ...
                        <fieldset>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRepairDate" runat="server" class="text_inp" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 180px;">
                                ...
                                <tr>
                                    <td>
                                        计划维修日期:<span style="color: Red">*</span>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtEquipmentRepairingdate" class="text_inp" runat="server" Width="300"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtEquipmentRepairingdate"
                                            Display="Dynamic" ErrorMessage="请选择设备计划维修日期！"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        实际维修日期: <span style="color: Red">*</span>
                                    </td>
                                    <td>
                                           <asp:TextBox ID="txtActualRepairDate" class="text_inp" runat="server" Width="300"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtActualRepairDate"
                                            Display="Dynamic" ErrorMessage="请选择设备实际维修日期！"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
