...
{
    public partial class Report_AssetIntall_Detail : System.Web.UI.Page
    {
        #region Events
        ...
        protected void LoadData(int pageIndex)
        {
            ...
            int recordCount = 0;
            var list = AssetsetupinfoService.RetrieveAssetReportDetailInfoPaging(search, pageIndex, pcData.PageSize, out recordCount);
