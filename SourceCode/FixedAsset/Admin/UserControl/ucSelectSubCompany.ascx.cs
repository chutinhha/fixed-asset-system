...
namespace FixedAsset.Web.Admin.UserControl
{
    public partial class ucSelectSubCompany : System.Web.UI.UserControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if(!IsPostBack)
            {
                btnSelectSingleSubCompany.Attributes.Add("onclick", string.Format("javascript:ShowTopDialogFrame('分公司选择', '{0}','SelectSingleSubCompany()',560,400);return false;", ResolveUrl("~/Admin/SelectSingleSubCompany.aspx")));
