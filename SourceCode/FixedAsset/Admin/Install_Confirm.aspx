<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Install_Confirm.aspx.cs" Inherits="FixedAsset.Web.Admin.Install_Confirm" %>
    ...
    <div class="content-box">
        <div class="content-box-header">
            <h3 style="cursor: s-resize;">
                <asp:Literal runat="server" ID="litTitle" Text="确认安装" />
            </h3>
        </div>
                ...
                <fieldset>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox TextMode="MultiLine" Height="80px" ID="txtSetupcontent" runat="server"
