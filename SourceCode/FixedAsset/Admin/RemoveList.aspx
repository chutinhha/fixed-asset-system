<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeBehind="RemoveList.aspx.cs" Inherits="FixedAsset.Web.Admin.RemoveList" %>
                ...
                <tr>
                    ...
                    <td>
                         <asp:DropDownList ID="ddlStatus" runat="server" Width="150px">
                                            <asp:ListItem>待拆机</asp:ListItem>
                                            <asp:ListItem>已拆机</asp:ListItem>
                                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
