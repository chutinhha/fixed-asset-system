...
{
    public partial class Report_AssetRemove_Detail : System.Web.UI.Page
    {
        #region Events
        ...
        protected void LoadData(int pageIndex)
        {
            ...
            int recordCount = 0;
            var list = AssetremoveService.RetrieveAssetReportDetailInfoPaging(search, pageIndex, pcData.PageSize, out recordCount);
