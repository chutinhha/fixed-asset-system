<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeBehind="Repair_Reply.aspx.cs" Inherits="FixedAsset.Web.Admin.Repair_Reply" %>
    ...
    <div class="content-box">
        <div class="content-box-header">
            <h3 style="cursor: s-resize;">
                <asp:Literal runat="server" ID="litTitle" Text="回复维修申请" />
            </h3>
        </div>
                ...
                <fieldset>
                     <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <uc1:ucDatePicker ID="ucPlanmaintaindate" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
